...
export default function PropertyChat() {
  ...
  // FIX MOBILE : Calcule la vraie hauteur pour éviter que Chrome ne cache le haut
  useEffect(() => {
    const setHeight = () => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'marc', text: "Petit souci technique, réessayez dans un instant." }]);
    ...
    <div className="app-container">
      ...
      <style jsx>{`
        ...
        header { 
          ...
          /* On force une grosse marge en haut pour Chrome Mobile */
      ...
      <div className="input-bar">
        ...
        <button className="send-btn" onClick={sendMessage}>
          {/* NOUVELLE ICÔNE AVION EN PAPIER (FINI LA FUSÉE) */}
