...
export default function CGU() {
  return (
    <div className="legal-container">
      <Head><title>Conditions Générales | Major Marc</title></Head>
      <style jsx>{`
      ...
      <section>
        <h2>1. Objet</h2>
        <p>Les présentes CGV/CGU encadrent l'utilisation du service Major Marc, un assistant virtuel basé sur l'intelligence artificielle pour la gestion de locations de courte durée.</p>
        ...
        <p>Major Marc utilise l'IA pour répondre aux voyageurs. Bien que nous fassions tout pour garantir l'exactitude des réponses, nous ne pouvons être tenus responsables des erreurs commises par l'IA. L'Hôte reste responsable des informations qu'il fournit à Marc (codes wifi, consignes, etc.).</p>
