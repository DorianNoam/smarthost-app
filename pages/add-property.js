...
export default function AddPropertyWizard() {
  ...
  const saveProgress = async (isFinal = false) => {
    ...
    try {
      ...
      if (propertyId) {
        // MODIFICATION : On précise l'ID, mais on ne définit PAS is_active.
        // Ainsi, Supabase garde la valeur actuelle (true) sans l'écraser.
        payload.id = propertyId;
      } else {
        // CRÉATION : On bloque le logement par défaut
      ...
      <div className="wizard-card">
        ...
        {step === 4 && (
          <div className="step">
            ...
            <div className="grid">
              ...
              <div className="input-group full"><label>Urgence Santé</label><textarea name="health_emergency_info" value={formData.health_emergency_info} onChange={handleChange} /></div>
            </div>
          </div>
        )}
        ...
        {step === 7 && (
          <div className="step">
            ...
            <div className="grid">
              ...
              <div className="input-group full"><label>Mode d'emploi Appareils</label><textarea name="appliances_instructions" value={formData.appliances_instructions} onChange={handleChange} /></div>
        ...
        {step === 9 && (
          <div className="step">
            ...
            <div className="grid">
              <div className="input-group full"><label>Détails spécifiques (Bruit, etc.)</label><textarea name="property_quirks" value={formData.property_quirks} onChange={handleChange} /></div>
