                    ...
                    <>
                      ...
                      {tab === 'menage' && (
                        <div className="tab-content">
                          ...
                          <input className="cleaning-input" placeholder="Nom du prestataire" value={cd.providerName || ''} onChange={e => updateCleaning(prop.id, 'providerName', e.target.value)} />
                          <input className="cleaning-input" placeholder="Telegram Chat ID" value={cd.providerTelegram || ''} onChange={e => updateCleaning(prop.id, 'providerTelegram', e.target.value)} />
                          <p style={{ margin: '2px 0 0', fontSize: '11px', color: '#94a3b8' }}>Le prestataire doit démarrer @AlfredMajorBot sur Telegram.</p>
                          ...
                          <div className="cleaning-actions">
                            <button className="btn-save-cleaning" onClick={() => saveCleaning(prop.id)} disabled={cd.saving}>
                              {cd.saving ? '⏳' : '💾 Sauvegarder'}
                            </button>
                            {cd.config && (
                              <button className="btn-notify-cleaning" onClick={() => triggerCleaning(prop.id)}>
                                🧹 Notifier
                              </button>
                            )}
                          </div>
