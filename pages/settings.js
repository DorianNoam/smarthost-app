  ...
  return (
    <div className="dashboard-layout">
      ...
      <style jsx>{`
        ...
        /* TELEGRAM BOX */
        .telegram-box { background: #f0f9ff; border: 1px solid #bae6fd; border-radius: 16px; padding: 20px; display: flex; flex-direction: column; gap: 15px; height: auto; }
        .telegram-status { display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 10px; }
        ...
        /* BOUTONS */
        .btn { padding: 12px 24px; border-radius: 12px; font-weight: 700; font-size: 14px; cursor: pointer; border: none; transition: 0.2s; display: inline-flex; align-items: center; justify-content: center; gap: 8px; box-sizing: border-box; }
        ...
        .btn-telegram { background: #0088cc; color: white; display: inline-flex; align-items: center; justify-content: center; gap: 8px; text-decoration: none; align-self: flex-start; }
        ...
        @media (max-width: 900px) {
          ...
          main { margin-left: 0; padding: 25px 20px; padding-bottom: 120px; }
          .input-grid { grid-template-columns: 1fr; }
          .input-group.full { grid-column: span 1; }
          .plan-box { flex-direction: column; align-items: flex-start; gap: 15px; }
          
          .btn-primary, .btn-outline, .btn-danger, .btn-telegram { width: 100%; align-self: stretch; }
        }
      `}</style>
        ...
        <div className="settings-container">
          ...
          <div className="settings-card">
            ...
            <div className="input-grid">
              ...
              <div className="input-group full">
                <button className="btn btn-primary" style={{alignSelf: 'flex-start'}}>Enregistrer les informations</button>
              </div>
            </div>
          </div>
          ...
          <div className="settings-card">
            ...
            <div className="input-grid">
              ...
              <div className="input-group full">
                <button className="btn btn-outline" style={{alignSelf: 'flex-start'}}>Changer de mot de passe</button>
              </div>
            </div>
          </div>
