    ...
    <div className="container">
      ...
      <style jsx>{`
        ...
        .hero {
          ...
          background:
            linear-gradient(180deg, rgba(0,0,0,0.52) 0%, rgba(0,0,0,0.38) 60%, rgba(0,0,0,0.62) 100%),
        ...
        .hero-badge {
          ...
          color: #f0d060; padding: 7px 16px; border-radius: 980px;
          font-size: 13px; font-weight: 500; margin-bottom: 40px; letter-spacing: -0.1px;
        }
        .hero h1 {
        ...
        .cta-primary {
          background: #c9a227; color: #1d1d1f;
          padding: 17px 38px; border-radius: 980px;
        ...
        .cta-secondary {
          color: rgba(255,255,255,0.65); font-size: 16px; font-weight: 400;
        ...
        .pillars-grid {
          ...
          border: 1px solid #e8e8ed; border-radius: 18px; overflow: hidden;
        ...
        .pillar-tag {
          ...
          background: #faf6e8; border: 1px solid #f0e6b0;
          padding: 3px 10px; border-radius: 980px; letter-spacing: 0.2px;
        }
        ...
        .pain {
          ...
          background:
            linear-gradient(rgba(0,0,0,0.88), rgba(0,0,0,0.84)),
        ...
        .pain-card {
          ...
          border-radius: 18px; overflow: hidden; text-align: left; transition: 0.3s;
        }
        ...
        .phone-frame {
          border: 8px solid #1d1d1f; border-radius: 48px; overflow: hidden;
          background: #fff;
          box-shadow: 0 48px 100px rgba(0,0,0,0.16), 0 0 0 1px rgba(0,0,0,0.04);
          height: 560px;
        }
        ...
        .urgence-tag {
          ...
          padding: 6px 14px; border-radius: 980px; font-size: 12px; font-weight: 600; margin-bottom: 24px;
        }
        ...
        .testi-card {
          background: #fff; border: 1px solid #e8e8ed; border-radius: 20px; padding: 32px; text-align: left;
        ...
        .pricing::before {
          ...
          border-radius: 50%; background: radial-gradient(circle, rgba(201,162,39,0.07) 0%, transparent 70%);
          pointer-events: none;
        }
        ...
        .price-promo {
          ...
          background: linear-gradient(135deg, #c9a227, #e8c84a); color: #1d1d1f;
          padding: 5px 22px; border-radius: 980px; font-size: 12px; font-weight: 600; white-space: nowrap;
        }
      ...
      <section className="referral">
        <div className="referral-inner">
          ...
          <a className="cta-primary" style={{display:'inline-flex'}} href="/register" onClick={handleRegisterClick}>
            Creer mon compte et obtenir mon lien →
          </a>
        </div>
      </section>
        ...
        <div className="footer-inner">
          ...
          <div className="footer-col">
            ...
            <ul>
              ...
              <li><a href="/register" onClick={handleRegisterClick}>Creer un compte</a></li>
